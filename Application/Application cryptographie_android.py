        ...
        ScreenManager:
            ...
            Screen:
                ...
                BoxLayout:
                    ...
                    FileChooserIconView:
                        id: file
                        on_selection: app.selected(file.selection)
            ...
            Screen:
                ...
                BoxLayout:
                    ...
                    FileChooserIconView:
                        id: file2
                        on_selection: app.selected2(file2.selection)
...
class DemoApp(MDApp):
    ...
    def selected(self, filename):
        source = filename[0]
        self.root.ids.my_image.source = source
        img_source = Image.open(source)
        img_source.save("Image_source.jpg")

    def selected2(self, filename):
        source = filename[0]
        self.root.ids.my_image_crypted2.source = source
        img_source = Image.open(source)
        img_source.save("Image_crypte_new.bmp")

    def encryption(self):
        img_source = Image.open("Image_source.jpg")
        ...
        self.root.ids.my_image_crypte.source = "image_crypte.bmp"
    ...
    def decryption(self):
        ...
        self.root.ids.my_image_decrypte.source = "image_decrypte.jpg"

        os.remove("image_crypte_new2.bmp")
        os.remove("key.pkl")
    ...
    def show_data(self, key):
        ...
        if len(key) < 92:
            ...
            with open("key.pkl", "wb") as keypickle:
